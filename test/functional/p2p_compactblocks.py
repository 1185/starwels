...
# TestP2PConn: A peer we use to send messages to starwelsd, and store responses.
...
class CompactBlocksTest(StarwelsTestFramework):
    ...
    # This test actually causes starwelsd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that starwelsd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for starwelsd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # starwelsd will not send blocktxn responses for blocks whose height is
