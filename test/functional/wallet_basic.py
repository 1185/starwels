...
class WalletTest(StarwelsTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 USDH from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 USDH in block rewards plus fees, but
        ...
        # Send 10 USDH with subtract fee from amount
        ...
        # Sendmany 10 USDH with subtract fee from amount
