...
By default, starwelsd will dump mempool on shutdown and
...
class MempoolPersistTest(StarwelsTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give starwelsd a second to reload the mempool
        ...
        self.log.debug("Prevent starwelsd from writing mempool.dat to disk. Verify that `savemempool` fails")
