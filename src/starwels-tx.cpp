...
static void SetupStarwelsTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " starwels-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  starwels-tx [options] <hex-tx> [commands]  Update hex-encoded starwels transaction\n" +
            "or:     starwels-tx [options] -create [commands]   Create hex-encoded starwels transaction\n" +
            "\n";
