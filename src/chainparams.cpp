    ...
    CMainParams() {
        ...
        */
        ...
        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 4194304 0x000000000006b154980f738a5d8359344f1c3c43fe0209da7b4033f379c3a413
            /* nTime    */ 1546793987,
            /* nTxCount */ 4243099,
            /* dTxRate  */ 2.4
        };
...
public:
    CTestNetParams() {
        ...
        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 4096 0x00000000d7674ad1e7703e7ba02b7611c12fe74de27b6a414cf6e906cc3599e9
            /* nTime    */ 1529914513,
            /* nTxCount */ 4172,
            /* dTxRate  */ 0.626
        };
