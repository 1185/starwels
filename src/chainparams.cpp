...
public:
    CMainParams() {
        ...
        consensus.BIP16Exception = uint256S("0x0000000047a4fa17266bf33f228fcf370206fb1948096521efd1baf00f1e94d9");
        ...
        */
        ...
        checkpointData = {
            {
                // 1517320634 1556464671 1517409431 704136802 1529914513 1155211149 1530100737 3507130640
                ...
                // 1530115458 2127567142 1530157844 3201332445 1530240588 1199797262
                ...
                // 1530390152 555394614 1530692464 763374868 1531254946 2429180701
        ...
        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 1048576 0000000000005f2135fde2a7944711b3a4c94117737aef500618395226ea98f3
            /* nTime    */ 1532461464,
            /* nTxCount */ 1065174,
            /* dTxRate  */ 2.4
        };
...
public:
    CTestNetParams() {
        ...
        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 4096 00000000d7674ad1e7703e7ba02b7611c12fe74de27b6a414cf6e906cc3599e9
            /* nTime    */ 1529914513,
            /* nTxCount */ 4172,
            /* dTxRate  */ 0.626
        };

        /* enable fallback fee on ai */
