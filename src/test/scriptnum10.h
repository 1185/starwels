...
#ifndef STARWELS_TEST_SCRIPTNUM10_H
#define STARWELS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Starwels 0.10.0, for cross-comparison.
 */
public:
