...
#ifndef STARWELS_QT_STARWELSUNITS_H
#define STARWELS_QT_STARWELSUNITS_H
...
/** Starwels unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class StarwelsUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit StarwelsUnits(QObject *parent);
...
typedef StarwelsUnits::Unit StarwelsUnit;

#endif // STARWELS_QT_STARWELSUNITS_H
