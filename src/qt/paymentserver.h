...
#ifndef STARWELS_QT_PAYMENTSERVER_H
#define STARWELS_QT_PAYMENTSERVER_H
...
public:
    ...
    // process.
    // Note: if a payment request is given, SelectParams(MAIN/AI)
...
#endif // STARWELS_QT_PAYMENTSERVER_H
