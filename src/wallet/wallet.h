...
#ifndef STARWELS_WALLET_WALLET_H
#define STARWELS_WALLET_WALLET_H
...
public:
     ...
     * on this starwels node, and set to 0 for transactions that were created
...
#endif // STARWELS_WALLET_WALLET_H
