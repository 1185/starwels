...
#ifndef STARWELS_INTERFACES_NODE_H
#define STARWELS_INTERFACES_NODE_H
...
//! Top-level interface for a starwels node (starwelsd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // STARWELS_INTERFACES_NODE_H
