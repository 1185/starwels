...
Most communication about Starwels development happens on IRC, in the
#starwels-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [botbot.me](https://botbot.me/freenode/starwels-dev/).
...
[Translation Process](https://github.com/starwels/starwels/blob/master/doc/translation_process.md) 
