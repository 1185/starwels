dnl Copyright (c) 2013-2019 The Starwels developers
     ...
     m4_ifdef([PKG_CHECK_MODULES],[
       ...
       if test "x$TARGET_OS" = xwindows; then
         ...
         if test "x$starwels_cv_need_platformsupport" = xyes; then
           STARWELS_QT_CHECK(AC_CHECK_LIB([${QT_LIB_PREFIX}PlatformSupport],[main],,STARWELS_QT_FAIL(lib${QT_LIB_PREFIX}PlatformSupport not found)))
         fi
       fi
     fi
  else
