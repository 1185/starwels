...
unlocked to sign the Starwels-Qt.app bundle.
...
allowing somebody to distribute a Starwels-Qt.app or starwels-qt-setup.exe with a valid
...
that the starwels-qt.exe file inside the installer had not been tampered with.
