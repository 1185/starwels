...
Assuming a local RPC server running on port 26552, it is possible to request:
- Blocks: http://localhost:26552/rest/block/*HASH*.*EXT*
- Blocks without transactions: http://localhost:26552/rest/block/notxdetails/*HASH*.*EXT*
- Transactions (requires `-txindex`): http://localhost:26552/rest/tx/*HASH*.*EXT*
...
- `c30329a` Add ai DNS seed of Alex Kotenko
- `45a4baf` Add ai DNS seed of Andreas Schildbach
...
- `e84843c` Broken addresses on command line no longer trigger ai
