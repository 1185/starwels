Starwels version 0.11.2 is now available from:

  <https://bitcoin.org/bin/bitcoin-0.11.2/>
...
- #6600 `1e672ae` Debian/Ubuntu: Include starwels-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split starwels-tx into its own package
- #5987 `33d6825` Bugfix: Allow mining on top of old tip blocks for ai
