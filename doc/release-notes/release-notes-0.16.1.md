...
- #12843 `df38b13` Test starting starwelsd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure starwelsd processes are cleaned up when tests end (sdaftuar)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/starwels/).
