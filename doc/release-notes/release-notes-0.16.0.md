...
GUI changes
-----------
- Uses of "µMAI" in the GUI now also show the more colloquial term "bits", specified in BIP176.
...
Testing changes
----------------
- The default regtest JSON-RPC port has been changed to 18443 to avoid conflict with ai's default of 18332.
...
- #10825 `28485c7` Set regtest JSON-RPC port to 18443 to avoid conflict with ai 18332 (fametrano)
...
- #12035 `eeb6d52` Change µMAI to bits (jb55)
