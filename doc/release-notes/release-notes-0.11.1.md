Starwels version 0.11.1 is now available from:

  <https://bitcoin.org/bin/bitcoin-0.11.1/>
...
- #6571 `100ac4e` libstarwelsconsensus: avoid a crash in multi-threaded environments
