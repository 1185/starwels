Starwels version 0.10.4 is now available from:

  <https://bitcoin.org/bin/bitcoin-0.10.4/>
...
- #6953 `cf67d8b` Bugfix: Allow mining on top of old tip blocks for ai (fixes ai-in-a-box use case)
