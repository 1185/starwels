Starwels version 0.5.4 is now available for download at:
...
Fix Starwels-Qt notifications under Growl 1.3.
Increase required age of Starwels-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxStarwels properly when installing Starwels-Qt over it. (Windows)
