...
Notable changes:
* Client will accept and relay TX's with 0.0005 MAI fee schedule (users still pay 0.01 MAI per kb, until next version)
* Non-standard transactions accepted on ai
...
* IRC is overflowing.  Client now bootstraps to channels #starwels00 - #starwels99
