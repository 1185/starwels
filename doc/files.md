...
* starwels.conf: contains configuration settings for starwelsd or starwels-qt
* starwelsd.pid: stores the process id of starwelsd while running
...
* debug.log: contains debug information and general logging generated by starwelsd or starwels-qt
