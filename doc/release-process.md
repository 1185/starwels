...
### Build and sign Starwels for Linux, Windows, and OS X:
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`starwels-${VERSION}-osx-unsigned.dmg`, `starwels-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import starwels/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
Codesigner only: Sign the osx binary:
    ...
    transfer starwels-osx-unsigned.tar.gz to osx for signing
